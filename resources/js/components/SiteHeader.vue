...
<template>
    <header
        class="sticky top-0 z-40 w-full border-b border-hairline bg-background/80 backdrop-blur-xl"
    >
        <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-3.5">
            ...
            <div class="flex items-center gap-2">
                <Link
                    href="/login"
                    class="hidden text-sm text-muted-foreground transition hover:text-foreground md:inline-block"
                >
                    Sign in
                </Link>
                <Link
                    href="/register"
                    class="group inline-flex items-center gap-1.5 rounded-lg bg-foreground px-3.5 py-2 text-sm font-medium text-background shadow-sm transition hover:bg-foreground/90"
                >
                    Start free
